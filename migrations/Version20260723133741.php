 ...
 */
final class Version20260723133741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `wallet_transactions` (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(10) NOT NULL, source VARCHAR(40) NOT NULL, amount NUMERIC(12, 2) NOT NULL, fee_amount NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, balance_after NUMERIC(12, 2) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, wallet_id INT NOT NULL, reservation_id INT DEFAULT NULL, withdrawal_request_id INT DEFAULT NULL, INDEX IDX_A50205E2712520F3 (wallet_id), INDEX IDX_A50205E2B83297E7 (reservation_id), INDEX IDX_A50205E22E695421 (withdrawal_request_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `wallets` (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(20) DEFAULT \'agency\' NOT NULL, available_balance NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, reserved_balance NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_earned NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_withdrawn NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, updated_at DATETIME NOT NULL, agency_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_967AAA6CCDEADB2A (agency_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `withdrawal_requests` (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, method VARCHAR(50) NOT NULL, status VARCHAR(50) NOT NULL, notes LONGTEXT DEFAULT NULL, admin_note LONGTEXT DEFAULT NULL, processed_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, agency_id INT NOT NULL, requested_by_user_id INT DEFAULT NULL, INDEX IDX_3E7DE8ACDEADB2A (agency_id), INDEX IDX_3E7DE8AA2DD2669 (requested_by_user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
