 ...
 */
final class Version20260909152832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_run (id INT AUTO_INCREMENT NOT NULL, command_name VARCHAR(191) NOT NULL, status VARCHAR(20) NOT NULL, started_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, duration_ms INT DEFAULT NULL, exit_code SMALLINT DEFAULT NULL, summary JSON DEFAULT NULL, issues JSON DEFAULT NULL, error_message LONGTEXT DEFAULT NULL, error_trace LONGTEXT DEFAULT NULL, host VARCHAR(191) DEFAULT NULL, triggered_by VARCHAR(20) DEFAULT NULL, INDEX idx_job_run_command_started (command_name, started_at), INDEX idx_job_run_status (status), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `support_responses` (id INT AUTO_INCREMENT NOT NULL, message LONGTEXT NOT NULL, channel VARCHAR(20) DEFAULT \'client\' NOT NULL, created_at DATETIME NOT NULL, ticket_id INT NOT NULL, agent_id INT DEFAULT NULL, author_id INT DEFAULT NULL, INDEX IDX_878D0422700047D2 (ticket_id), INDEX IDX_878D04223414710B (agent_id), INDEX IDX_878D0422F675F31B (author_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
